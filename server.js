...
let Etapas= [
	...
	{id:"110", semana:"Semana 10", descripción:"La barriga empezará a aumentar de tamaño debido a que el feto hace lo propio y muy rápidamente. En estos momentos, puede que los síntomas vayan remitiendo aunque los cambios en el estado de ánimo, debido a las alteraciones hormonales, podrían mantenerse.",}, 
	{id:"111", semana:"Semana 11", descripción:"El feto ya realiza ciertas actividades por sí mismo, como orinar o tragar. Puede incluso mover sus extremidades. La llegada del segundo trimestre anuncia un período mucho más tranquilo para la madre, aunque debe seguir cuidando la dieta y la salud. Es recomendable la actividad física, pero de forma moderada, como caminar o practicar yoga.",}, 
	{id:"112", semana:"Semana 12", descripción:"Finaliza el primer trimestre y con él, los peores síntomas del embarazo. La barriga ya empieza a notarse y el bebé sigue creciendo a buen ritmo. Su rostro cada vez es más definido y los órganos van perfeccionándose.",},
	},  
	{id: "2", periodo:"SEGUNDO TRIMESTRE", 
	Información2:
	{id:"21", semanas:"Semanas 133 - 16", descripción:"La etapa más delicada del embarazo ya ha pasado, el riesgo de aborto involuntario ha disminuido considerablemente y los síntomas también. Eso sí, la barriga crece y crece, por lo que es momento de comprar ropa premamá que sea cómoda. Hay que tener precaución con lo que se come, ya que es normal ingerir comida de más. Los pechos siguen aumentando y se preparan para la lactancia. El bebé, por su parte, empieza a oír gracias a la consolidación de los huesos auditivos. Durante este período, se produce uno de los momentos más emocionantes del embarazo ya que toca conocer el sexo del bebé.",},
